...
実際、python勉強してまだ１か月ちょいなので僕よりもうまい人が作ってください(日本語弱者)
## はうとぅーゆーず
1. リポジトリをクローンします:
    ```sh
...
11. 右に仮想デスクトップを作り、hakko aiのチャット画面を開いておきます。

12. VSCodeのコマンドパレット（Ctrl+Shift+P）を開き、extension.optimizeCodeコマンドを実行する。